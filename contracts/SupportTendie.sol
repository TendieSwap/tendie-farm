...
// SupportTendie is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterTendie.
contract SupportTendie {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many SPICYTENDIE tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws SPICYTENDIE tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes SpicyTendie tokens.
    ...
    // Deposit SpicyTendie tokens to SupportTendie for Reward allocation.
    ...
    // Withdraw SpicyTendie tokens from SupportTendie.
