...
contract('Timelock', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        this.cake = await TendieToken.new({ from: alice });
    ...
    it('should also work with MasterTendie', async () => {
        ...
        this.chef = await MasterTendie.new(this.cake.address, this.syrup.address, dev, '1000', '0', { from: alice });
